  ...
  return (
    <div className="flex mb-4 p-5">
          ...
          <div className="w-96 border-2 p-7 rounded-lg">
            ...
            <div className="flex-grow flex items-center">
              ...
              <p className="text-base ml-6">
                {" "}
                Gedung A.F Lasut X Jl. Soekarno Hatta No.444, Pasirluyu, Kec.
                Regol, Kota Bandung, Jawa Barat 40254
              </p>
            </div>
            <div className="flex-grow flex items-center">
              <img src={Clock} alt="" />
              <p className="text-base ml-6">
                ...
                Jum’at : 08.00 - 16.30 WIB <br /> Sabtu dan Minggu : Tutup{" "}
                <br /> Tanggal Merah Lainnya : Tutup
              </p>
            </div>
            <div className="py-2 px-4 bg-[#242E3A] text-[#F9AE0C] w-32 rounded-md cursor-pointer">
              Kontak Kami
            </div>
          </div>
        )}
      ...
      <div className="flex-grow ml-14 mt-2 font-readux">
        <div>
          <span className="text-3xl font-bold">Tentang</span>{" "}
          <span className="text-3xl">GeoRima</span>
        </div>
        <p className="mt-6">
          ...
          mus. Mauris vulputate ligula vel vestibulum sagittis. Duis rutrum ac
          ex vel consectetur. Duis in tortor id magna bibendum tempor. Sed in
          elementum sapien. Ut sed condimentum purus, in interdum purus.
          Phasellus imperdiet dictum malesuada. Sed a orci leo. Duis lorem
          ipsum, consectetur quis nunc eu, laoreet facilisis elit. Donec blandit
          augue eu maximus varius. Donec vitae leo ultrices, pretium massa sit
          amet, pellentesque est.
        </p>
        <div>
          <span className="text-2xl font-bold">Badan</span>{" "}
          <span className="text-2xl">Keanggotaan</span>
